...
const Update = (props) => {
    ...
    const [event, setEvent] = useState({
        ...
        dayCounter: props.data.dayCounter,
        gender: props.data.gender,
        minAge: props.data.minAge,
        maxAge: props.data.maxAge,
    })
    ...
    const handleChange = async (e) => {
        ...
        const selected = await APIapp.patch(`events/${props.data._id}`, formData)
        ...
        <>
                <div className="update">
                    ...
                    <div className="modal-content">
                        <span className="inform">Chỉnh sửa sự kiện</span>
                        <div className="form">
                            ...
                            <input type="number" placeholder="Days occurs" onChange={(e) => setEvent({...event, dayCounter:e.target.value})}/>
